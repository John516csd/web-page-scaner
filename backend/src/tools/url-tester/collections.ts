...
const DEFAULT_SEED: TestCollection[] = [
  {
    ...
    testCases: [
      { id: 'vr-1', name: '日语浏览器访问首页 — 不重定向', description: 'Accept-Language 为日语，应直接返回首页（HTTP 200），不发生语言重定向', url: 'https://www.notta.ai/', headers: { 'Accept-Language': 'ja-JP,ja;q=0.9' }, expectedStatus: 200 },
      { id: 'vr-2', name: '英语浏览器访问首页 — 302 到 /en/', description: 'Accept-Language 为英语，应重定向到 /en/', url: 'https://www.notta.ai/', headers: { 'Accept-Language': 'en-US,en;q=0.9' }, expectedStatus: 302, expectedRedirectUrl: 'https://www.notta.ai/en/' },
      { id: 'vr-3', name: 'Cookie 语言优先 — 302 到 /es/', description: '设置 selected-lang=es cookie 后应重定向到 /es/', url: 'https://www.notta.ai/', cookies: { 'selected-lang': 'es' }, expectedStatus: 302, expectedRedirectUrl: 'https://www.notta.ai/es/' },
      ...
      { id: 'vr-12', name: '俄语浏览器 — fallback 到 /en/', description: '俄语 Accept-Language 不在支持列表中，应 fallback 到 /en/', url: 'https://www.notta.ai/', headers: { 'Accept-Language': 'ru' }, expectedStatus: 302, expectedRedirectUrl: 'https://www.notta.ai/en/' },
      ...
      { id: 'ex-2', name: '多语言重定向 — 德语', description: '/de/audio-transkribieren 应 301 重定向到 /de/tools/audio-to-text-converter', url: 'https://www.notta.ai/de/audio-transkribieren', expectedStatus: 301, expectedRedirectUrl: 'https://www.notta.ai/de/tools/audio-to-text-converter' },
